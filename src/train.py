...
def main():
    ...
    parser.add_argument("--weight_decay", type=float, default=1e-4,
                         help="L2 regularization strength. Added after the first "
                              ...
                              "while val_loss more than doubled (0.76->1.61) - "
                              "clear overfitting, confirmed by recall plateauing "
                              "at ~72% even at aggressive classification "
                              "thresholds (see evaluate.py results / README).")
...
if __name__ == "__main__":
    main()"""Training loop for the PCam classifier."""
